...
const changeColorScheme = (colorScheme: string) => {
    ...
    if (themeLink === null) return;
    const themeLinkHref = themeLink.getAttribute('href');
    if (themeLinkHref === null) return;
...
const replaceLink = (linkElement: HTMLElement, href: string, onComplete: CallableFunction) => {
    if (!linkElement || !href) {
        return;
    }
...
const changeInputStyle = (styleClass: string) => {
        ...
        <div class="px-2">
            ...
            <div class="flex flex-wrap row-gap-3">
                <div v-for="(theme, i) in themes" :key="i" class="w-3">
                    <Button
                        :auto-focus="layoutConfig.theme.value === theme.name"
            ...
            <template v-if="!simple">
                ...
                <div class="flex flex-wrap row-gap-3">
                    <div class="flex align-items-center gap-2 w-6">
                        <RadioButton name="menuMode" value="static" v-model="layoutConfig.menuMode.value" input-id="mode1"></RadioButton>
                        <label for="mode1">Static</label>
                    </div>

                    <div class="flex align-items-center gap-2 w-6 pl-2">
                        <RadioButton name="menuMode" value="overlay" v-model="layoutConfig.menuMode.value" input-id="mode2"></RadioButton>
                        <label for="mode2">Overlay</label>
                    </div>
                    <div class="flex align-items-center gap-2 w-6">
                        <RadioButton name="menuMode" value="slim" v-model="layoutConfig.menuMode.value" input-id="mode3"></RadioButton>
                        <label for="mode3">Slim</label>
                    </div>
                    <div class="flex align-items-center gap-2 w-6 pl-2">
                        <RadioButton name="menuMode" value="slim-plus" v-model="layoutConfig.menuMode.value" input-id="mode4"></RadioButton>
                        <label for="mode4">Slim+</label>
                    </div>
                    <div class="flex align-items-center gap-2 w-6">
                        <RadioButton name="menuMode" value="horizontal" v-model="layoutConfig.menuMode.value" input-id="mode5"></RadioButton>
                        <label for="mode5">Horizontal</label>
                    </div>
                    <div class="flex align-items-center gap-2 w-6 pl-2">
                        <RadioButton name="menuMode" value="reveal" v-model="layoutConfig.menuMode.value" input-id="mode6"></RadioButton>
                        <label for="mode6">Reveal</label>
                    </div>
                    <div class="flex align-items-center gap-2 w-6">
                        <RadioButton name="menuMode" value="drawer" v-model="layoutConfig.menuMode.value" input-id="mode7"></RadioButton>
            ...
            <div class="flex flex-wrap row-gap-3">
                <div class="flex align-items-center gap-2 w-6">
                    <RadioButton name="menuTheme" value="light" v-model="layoutConfig.menuTheme.value" :disabled="layoutConfig.colorScheme.value == 'dark' || isHorizontal" input-id="menutheme-light"></RadioButton>
                    <label for="menutheme-light">Light</label>
                </div>
                <div class="flex align-items-center gap-2 w-6 pl-2">
                    <RadioButton name="menuTheme" value="dark" v-model="layoutConfig.menuTheme.value" :disabled="layoutConfig.colorScheme.value == 'dark' || isHorizontal" input-id="menutheme-dark"></RadioButton>
            ...
            <div class="flex flex-wrap row-gap-3">
                <div class="flex align-items-center gap-2 w-6">
                    <RadioButton name="topbarTheme" value="light" v-model="layoutConfig.topbarTheme.value" :disabled="layoutConfig.colorScheme.value == 'dark'" input-id="topbartheme-light"></RadioButton>
                    <label for="topbartheme-light">Light</label>
                </div>
                <div class="flex align-items-center gap-2 w-6 pl-2">
                    <RadioButton name="topbarTheme" value="dark" v-model="layoutConfig.topbarTheme.value" input-id="topbartheme-dark"></RadioButton>
                    <label for="topbartheme-dark">Dark</label>
                </div>
                <div class="flex align-items-center gap-2 w-6">
                    <RadioButton name="topbarTheme" value="transparent" v-model="layoutConfig.topbarTheme.value" input-id="topbartheme-transparent"></RadioButton>
            ...
            <template v-if="!simple">
                ...
                <div class="flex">
                    <div class="field-radiobutton flex-1">
                        <RadioButton name="inputStyle" value="outlined" v-model="layoutConfig.inputStyle.value" input-id="outlined_input" @change="changeInputStyle('outlined')"></RadioButton>
                        <label for="outlined_input">Outlined</label>
                    </div>
                    <div class="field-radiobutton flex-1">
                        <RadioButton name="inputStyle" value="filled" v-model="layoutConfig.inputStyle.value" @change="changeInputStyle('filled')" input-id="filled_input"></RadioButton>
