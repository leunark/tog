            ...
            <div class="flex flex-column align-items-center justify-content-center w-full md:w-4 h-full text-center py-6 px-4">
                ...
                <div class="flex flex-column">
                    ...
                    <span class="p-input-icon-left w-full mb-4">
                        ...
                        <Password id="password" placeholder="Password" v-model="value" class="w-full" :input-style="{ paddingLeft: '2.5rem' }" input-class="w-full md:w-25rem text-color-secondary surface-50 border-200" toggle-mask></Password>
                    </span>
                    ...
                    <Button label="Sign Up" class="w-full mb-4" @click="navigateToDashboard" v-ripple></Button>
