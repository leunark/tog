...
onMounted(() => {
    selectedDate.value = dateRanges.value[0];
    initChart();
});
watch(selectedDate, () => {
    ...
    const externalTooltipHandler = (context) => {
        ...
        if (tooltip.body) {
            ...
            titleLines.forEach((title) => {
                ...
                th.innerText = selectedDate.value.code == 'DAY' ? 'Day ' : '';
            ...
            trFooter.innerHTML =
                ...
                (selectedDate.value.code == 'DAY' ? orders.value.dailyData.avarageUnitByOrder : selectedDate.value.code == 'WEEK' ? orders.value.weeklyData.avarageUnitByOrder : orders.value.monthlyData.avarageUnitByOrder) +
                `</b></br></br> ` +
                `<span> Avarage Sales/Order: </span>
                </br> <b>` +
                (selectedDate.value.code == 'DAY' ? orders.value.dailyData.avarageSalesByOrder : selectedDate.value.code == 'WEEK' ? orders.value.weeklyData.avarageSalesByOrder : orders.value.monthlyData.avarageSalesByOrder) +
                `</b></br></br> ` +
                `<span> Total Sales: </span>
                </br> <b>` +
                (selectedDate.value.code == 'DAY' ? orders.value.dailyData.totalSales : selectedDate.value.code == 'WEEK' ? orders.value.weeklyData.totalSales : orders.value.monthlyData.totalSales) +
                `</b>`;
...
const onGlobalFilter = () => {
    table.value.filterGlobal(event.value.target.value, 'contains');
};
</script>
...
<template>
    <div class="grid">
        <div class="col-12">
            ...
            <div class="grid p-3" style="margin: -1rem">
        ...
        <div class="col-12 xl:col-8 p-3">
            <div class="card">
                ...
                <Chart type="bar" :height="160" :data="chartData" :options="chartOptions"></Chart>
            </div>
        </div>
                ...
                <div class="col-12 md:col-6 xl:col-12">
                    <div class="card">
                        ...
                        <TabView class="w-full p-0">
                            <TabPanel>
                                <template #header>
                                    <div class="pr-2" v-badge="6" severity="info">
                                ...
                                <ul class="list-none p-0 overflow-auto" style="margin: 0 -1.5rem -1rem; max-height: 17.745rem">
                                    <li class="border-round-lg pt-2 px-3 pb-2 mb-3" style="background-color: var(--primary-lighter-color)">
                                        ...
                                        <div class="flex justify-content-between align-items-center">
                                            ...
                                            <Button type="button" icon="pi pi-ellipsis-v" class="p-button-rounded p-button-text p-button-sm flex-shrink-0" @click="menu.toggle($event)"></Button>
                                        </div>
                                    </li>
                                    <li class="border-round-lg pt-2 px-3 pb-2 mb-3" style="background-color: var(--primary-lighter-color)">
                                        <div class="flex justify-content-between align-items-center mb-1">
                            ...
                            <TabPanel>
                                <template #header>
                                    <div class="pr-2" v-badge="3" severity="warning">
                                ...
                                <ul class="list-none p-0 overflow-auto" style="margin: 0 -1.5rem -1rem; max-height: 17.745rem">
                                    <li class="border-round-lg pt-2 px-3 pb-2 mb-3" style="background-color: var(--primary-lighter-color)">
                                        ...
                                        <div class="flex justify-content-between align-items-center">
                                            ...
                                            <Button type="button" icon="pi pi-ellipsis-v" class="p-button-rounded p-button-text p-button-sm flex-shrink-0" @click="menu2.toggle($event)"></Button>
                                        </div>
                                    </li>
                                    <li class="border-round-lg pt-2 px-3 pb-2 mb-3" style="background-color: var(--primary-lighter-color)">
                                        <div class="flex justify-content-between align-items-center mb-1">
        ...
        <div class="col-12 xl:col-3 p-3">
            <div class="card overflow-auto">
                ...
                <Button v-ripple type="button" label="Go to Clients Reports" class="p-button-outlined w-full"></Button>
            </div>
        </div>
            ...
            <div class="card h-full">
                <div class="card-header gap-3">
                    ...
                    <div class="inline-flex align-items-center">
                        ...
                        <Button v-ripple icon="pi pi-upload" class="p-button-rounded mx-3" @click="dt.exportCSV()"></Button>
                    </div>
                </div>
                <DataTable :value="activeAds" :rows="3" :paginator="true" v-model:expandedRows="expandedRows">
                    <Column expander style="width: 3rem" />
                    <Column field="name" header="Name" class="px-1" :sortable="true" />
                    <Column header="">
