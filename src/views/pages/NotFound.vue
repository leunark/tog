    ...
    <div>
        ...
        <div class="flex flex-column justify-content-center align-items-center px-4" style="min-height: calc(100vh - 62px)">
            <div class="flex flex-column justify-content-center align-items-center text-center">
                <img src="/layout/images/pages/asset-404.svg" alt="freya-layout" style="margin-bottom: -150px; width: 332px; height: 271px" />
                ...
                <Button v-ripple type="button" label="Go back to home" class="mt-4 font-medium p-button-lg" style="" @click="navigateToDashboard"></Button>
            </div>
