            ...
            <div class="flex flex-column align-items-center justify-content-center w-full md:w-4 h-full text-center py-6 px-4">
                ...
                <div class="flex flex-column">
                    <span class="p-input-icon-left w-full mb-4">
                        ...
                        <Password id="password" placeholder="Password" v-model="value1" class="w-full" :input-style="{ paddingLeft: '2.5rem' }" input-class="w-full md:w-25rem text-color-secondary surface-50 border-200" toggle-mask></Password>
                    </span>
                    <span class="p-input-icon-left w-full mb-4">
                        <i class="pi pi-lock z-2"></i>
                        <Password
                            ...
                            input-class="w-full md:w-25rem text-color-secondary surface-50 border-200"
                            toggle-mask
                            :feedback="false"
                        ></Password>
                    </span>
                    <div class="flex flex-wrap gap-2 justify-content-between">
                        ...
                        <Button v-ripple label="Submit" class="flex-auto" @click="navigateToDashboard"></Button>
                    </div>
                </div>
            </div>
