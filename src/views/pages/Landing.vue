...
const activeImage = ref('/layout/images/landing/chat.png');
const images = [
    { name: 'chat', src: '/layout/images/landing/chat.png' },
    { name: 'mail', src: '/layout/images/landing/mail.png' },
    { name: 'kanban', src: '/layout/images/landing/kanban.png' },
    { name: 'task-list', src: '/layout/images/landing/task-list.png' },
    { name: 'blog', src: '/layout/images/landing/blog.png' },
];

const features: any = ref(null);
const customizations: any = ref(null);
const apps: any = ref(null);
const pricing: any = ref(null);
...
const customHover = () => {
    ...
    if (mouseOverContainer && ex1Layer) {
        mouseOverContainer.onmousemove = function (e) {
            ...
            const position: [number, number, HTMLElement] = [...xy, ex1Layer];
...
<template>
    <div :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'h-auto ' : 'overflow-hidden h-screen  md:h-auto ') + 'landing-wrapper'">
        ...
        <div class="flex align-items-center justify-content-between relative lg:static py-6 mx-0 px-4 lg:py-6">
            <a class="cursor-pointer" @click="navigateToLanding">
            ...
            <a
                v-ripple
                class="cursor-pointer block md:hidden text-700 text-primary"
            ...
            <ul ref="menu" style="top: 0px; right: 0%" class="list-none flex-grow-1 justify-content-end hidden md:flex absolute md:relative h-screen md:h-auto surface-card md:surface-ground m-0 z-5 w-full sm:w-6 md:w-full py-6 md:py-0">
                <a
                    v-ripple
                    class="cursor-pointer block md:hidden text-700 text-primary absolute"
                ...
                <li class="mt-5 md:mt-0">
                    <a
                        ...
                        class="flex m-0 md:ml-5 md:px-0 px-3 py-3 text-900 font-medium line-height-3 hover:text-primary cursor-pointer"
                    >
                        <span>Home</span>
                    </a>
                </li>
                ...
                <li class="flex align-items-center">
                    <Button v-ripple type="button" v-styleclass="{ selector: '@grandparent', enterClass: 'hidden', enterActiveClass: 'px-fadein', leaveToClass: 'hidden' }" label="Buy Now" class="m-0 mt-3 md:mt-0 ml-3 md:ml-5"></Button>
                </li>
            </ul>
        </div>
        <div ref="home" id="home" class="landing-banner px-4 md:px-8 py-8 lg:flex flex-wrap">
            <div class="banner-left w-full lg:w-8">
                ...
                <Button label="Learn More" icon="pi pi-arrow-right" class="p-button-lg mb-6"></Button>
                ...
                <div class="logo-section relative w-full md:w-8 mt-6">
                    ...
                    <div class="marquee-wrapper relative overflow-hidden flex gap-6">
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="/layout/images/landing/logocloud/alfred-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/bastion-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/charot-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/franki-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/hodly-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/hyper-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/shodan-500.svg" class="h-2rem" alt="" />
                        </div>
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="/layout/images/landing/logocloud/alfred-500.svg" class="h-2rem" alt="" />
                            <img src="/layout/images/landing/logocloud/bastion-500.svg" class="h-2rem" alt="" />
        ...
        <div ref="features" id="features" class="landing-section px-4 md:px-8 py-8 mb-8">
            <div class="section-top lg:flex w-full gap-6 align-items-center mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-900 lg:w-8">Wide range of features and the stylish use of <b class="text-primary font-medium">PrimeNG</b> components</span>
                <div class="lg:w-4 lg:mt-0 mt-5">
                    ...
                    <Button label="Learn More" icon="pi pi-arrow-right" class="p-button-lg"></Button>
                </div>
            </div>
        ...
        <div ref="customizations" id="customizations" class="landing-section px-4 md:px-8 py-8 mt-8">
            ...
            <div class="video relative" style="max-width: 62rem; margin: 0 auto">
                <img src="/layout/images/landing/image-3.png" class="w-full border-round-3xl mb-4" alt="" />
                <Button icon="pi pi-play text-8xl ml-3" @click="showModalDialog()" class="absolute top-50 right-50 p-button-rounded text-3xl" style="margin-right: -5rem; margin-top: -5rem; height: 10rem; width: 10rem"></Button>
            </div>
            <Dialog :pt="{ content: { style: 'flex-grow:1' } }" header="Video Content" v-model="displayModal" :modal="true" :style="{ width: '80vw', height: '45vw' }" :draggable="false" :resizable="false">
                <iframe
            ...
            <div class="content lg:flex justify-content-between gap-6">
                <div class="left lg:w-6">
                    <h4 class="w-11 font-normal text-900 m-0 mb-6 line-height-3" style="letter-spacing: 0.6px">
                        Streamline your project building process and save valuable time with the ready-to-use applications offered by <b class="font-medium">FREYA</b>. From Kanban boards to Chat, Mail, Product Reviews, Checkout and more, our suite of
                        pre-made tools will have you up and running in no time. Start fast-tracking your success and take advantage of the time-saving features of <b class="font-medium">FREYA today.</b>
                    </h4>
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(2)" :style="activeLink == 2 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Kanban</a>
                            <i v-if="activeLink == 2" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
                        </li>
                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(3)" :style="activeLink == 3 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Task List</a>
                            <i v-if="activeLink == 3" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
                        </li>
                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(4)" :style="activeLink == 4 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Blog</a>
                ...
                <div class="flex flex-wrap mt-5 -mx-3">
                    <div class="w-full lg:w-4 p-3">
                        <div class="p-4 h-full surface-card" style="border-radius: 24px">
                            ...
                            <Button v-ripple label="Create Account" icon="pi pi-arrow-right" icon-pos="right" class="lg:w-full font-medium p-2 p-button-lg p-button-outlined"></Button>
                    ...
                    <div class="w-full lg:w-4 p-3">
                        <div class="p-4 h-full surface-card" style="border-radius: 24px">
                            ...
                            <Button v-ripple label="Proceed Monthly" icon="pi pi-arrow-right" icon-pos="right" class="lg:w-full font-medium p-2 p-button-lg"></Button>
                    ...
                    <div class="w-full lg:w-4 p-3">
                        <div class="p-4 h-full flex flex-column surface-card" style="border-radius: 24px">
                            ...
                            <Button v-ripple label="Proceed Yearly" icon="pi pi-arrow-right" icon-pos="right" class="lg:w-full font-medium p-2 p-button-lg"></Button>
            ...
            <div class="pt-8 pb-6">
                <div class="grid pb-6 border-bottom-1 border-300">
                    ...
                    <div class="col-12 md:col-3">
                        ...
                        <Button v-ripple label="Join" class="px-5 mt-3 py-3"></Button>
                    </div>
                </div>
